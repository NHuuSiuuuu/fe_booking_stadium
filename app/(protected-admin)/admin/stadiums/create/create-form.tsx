...
type CreateStadiumType = z.TypeOf<typeof CreateStadiumBody>;
export default function CreateForm() {
  ...
  const {
    ...
    reset,
    formState: { errors },
  } = useForm<CreateStadiumType>({
    resolver: zodResolver(CreateStadiumBody),
    defaultValues: {
      name: "",
      address: "",
      lng: "",
  ...
  =======================*/
  const onSubmit = async (data: CreateStadiumType) => {
    setIsPending(true);
  ...
  return (
    <div className="w-full p-6 mx-auto wg-gray-1060">
      <h1 className="mb-6 text-2xl font-bold text-gray-800">Thêm mới Sân</h1>
